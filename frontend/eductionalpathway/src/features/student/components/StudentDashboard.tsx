...
import { Award, BookOpen, Clock, TrendingUp, ChevronRight, GraduationCap } from 'lucide-react';
...
export const StudentDashboard = () => {
  ...
  const stats = [
    { label: 'Saved', value: '0', icon: Award, color: 'text-primary', bg: 'bg-primary/10' },
    { label: 'My Apps', value: '0', icon: BookOpen, color: 'text-secondary', bg: 'bg-secondary/10' },
    { label: 'Time Spent', value: '--', icon: Clock, color: 'text-accent', bg: 'bg-accent/10' },
    { label: 'Setup Score', value: '0%', icon: TrendingUp, color: 'text-green-600', bg: 'bg-green-100' },
  ];
      ...
      <section className="relative overflow-hidden rounded-xl bg-primary p-8 md:p-12 scholarship-gradient shadow-2xl shadow-primary/20">
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-blue-100 text-lg md:text-xl font-medium max-w-md">
            Your academic adventure is in full swing. We&apos;ve found some new opportunities for you today.
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/dashboard/scholarships" className="text-sm font-bold text-primary hover:underline flex items-center gap-1">
            ...
            <Card className="border-dashed py-12">
              <CardBody className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm text-muted-foreground max-w-xs">
                  We&apos;ll notify you when we find scholarships matching your profile.
                </p>
              </CardBody>
            </Card>
          </div>
        ...
        <div className="space-y-4">
          ...
          {!user?.isOnboarded && (
            <div className="bg-primary p-6 rounded-xl text-white scholarship-gradient shadow-xl shadow-primary/20">
              <h3 className="font-bold text-lg mb-2">Complete Onboarding</h3>
              <p className="text-sm text-gray-100 mb-6 font-medium">Complete your profile to unlock full features.</p>
              <Link 
                href="/onboarding" 
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-3">
              <Button 
                variant="ghost" 
                className="w-full text-left p-3 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-between group h-auto font-medium text-gray-700"
              >
