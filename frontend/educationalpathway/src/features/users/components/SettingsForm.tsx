    ...
    <div className="space-y-8">
            ...
            <CardBody className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Button
                    variant="ghost"
                    className="p-0 h-auto font-bold text-primary hover:bg-transparent"
                  >
                    Configure
                  </Button>
                </div>
      ...
      <div>
        ...
        <p className="text-gray-600 mb-4">
          Switch between light, dark, or follow system preferences.
        </p>
        <div className="flex gap-2">
          {modes.map((m) => (
            <Button
              key={m}
              variant={mode === m ? "scholarship" : "outline"}
              onClick={() => setMode(m)}
              size="sm"
            >
