...
import { validate, registerValidation, loginValidation, forgotPasswordValidation, resetPasswordValidation, changePasswordValidation, } from "../validators/validationMiddleware.js";
import { authLimiter, passwordResetLimiter, createAccountLimiter, } from "../middlewares/rateLimiter.js";
const router = Router();
// Public routes with rate limiting
router.post("/register", createAccountLimiter, validate(registerValidation), AuthController.register);
