...
router.get('/student/bookings', authorize(UserRole.STUDENT), CounselorController.getStudentBookings);
...
router.get('/me/payouts', authorize(UserRole.COUNSELOR), CounselorController.getMyPayouts);
